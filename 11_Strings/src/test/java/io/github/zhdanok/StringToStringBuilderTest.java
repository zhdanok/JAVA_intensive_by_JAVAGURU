...
class StringToStringBuilderTest {

    Logger logger = LoggerFactory.getLogger(StringToStringBuilderTest.class);

    @Spy
    StringToStringBuilder stringToStringBuilder;

    @BeforeEach
    void setUp() {
        stringToStringBuilder = new StringToStringBuilder();
    }

    @Test
    void splitText() {
        String text = "Те, кто добивается выдающихся результатов, обращают внимание даже на самые незначительные " +
        ...
        String actual = stringToStringBuilder.transformText(text);
